...
#ifndef DOGBOT_DRIVE_CONTROLLER_SPEED_LIMITER_HPP_
#define DOGBOT_DRIVE_CONTROLLER_SPEED_LIMITER_HPP_
...
namespace dogbot_drive_controller {
    ...
    public:
         ...
         * \return Limiting factor (1.0 if none)
         */
        double limit_velocity(double &v) const;
         ...
         * \return Limiting factor (1.0 if none)
         */
        double limit_acceleration(double &v, double v0, double dt) const;
         ...
         */
        double limit_jerk(double &v, double v0, double v1, double dt) const;
...
#endif  // DOGBOT_DRIVE_CONTROLLER_SPEED_LIMITER_HPP_
