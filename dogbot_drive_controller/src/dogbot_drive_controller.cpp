...
namespace dogbot_drive_controller
{
  ...
  controller_interface::CallbackReturn DogBotDriveController::on_configure(const rclcpp_lifecycle::State &)
  {
    ...
    odometry_.setWheelParams(wheel_separation_x, wheel_separation_y, lf_wheel_radius, rf_wheel_radius, lb_wheel_radius, rb_wheel_radius);
  ...
  bool DogBotDriveController::reset()
  {
